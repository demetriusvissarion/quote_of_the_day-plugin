...
////////////////////////////////////////////////////
class QuotesManagementModel
{
	// Register the "Quotes Management" custom post type
	public function quote_of_the_day_plugin_register_post_type()
	{
		$labels = array(
	...
	public function quote_of_the_day_plugin_quotes_management()
	{
	...
	public function quote_of_the_day_manage_quotes_page()
	{
		$quote_menu_enabled = get_option('quote_menu_enabled', true);
...
// Instantiate the Quotes Management Model
$management_model = new QuotesManagementModel();
